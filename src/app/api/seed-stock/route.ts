...
const RECEIPTS: Receipt[] = [
  ...
  // ── 8. G-Wholesalers #0038473 ──
  {
    ...
    items: [
      ...
      { code: '000001098', name: 'AJAB MOBAIL 500', size: '500G', unitType: 'PC', ppu: 1, qty: 1, unitCost: 1050, vat: 'B' },
      { code: '000001311', name: 'AJAB 1KG', size: '1KG', unitType: 'BAG', ppu: 1, qty: 1, unitCost: 2100, vat: 'B' },
      { code: '000002079', name: 'BROOKSIDE 200ML', size: '200ML', unitType: 'PC', ppu: 1, qty: 1, unitCost: 640, vat: 'B' },
  ...
  // ── 10. Tawakall #0006728 (big order — 107 lines) ──
  {
    ...
    items: [
      ...
      { code: '1000832', name: 'FOOD COLOUR', size: 'DOZ', unitType: 'DOZ', ppu: 1, qty: 10, unitCost: 420, vat: 'B' },
      ...
      { code: '000004584', name: 'SHENKE ELECTRIC', size: '120PC', unitType: 'PKT', ppu: 1, qty: 10, unitCost: 70, vat: 'A' },
